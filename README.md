...
- El estatus de membresía (Activa / Por vencer / Vencida) se **calcula en vivo** por fecha
  (`calcularEstatus` en [`lib/utils.ts`](lib/utils.ts)); es un derivado, no se almacena.
